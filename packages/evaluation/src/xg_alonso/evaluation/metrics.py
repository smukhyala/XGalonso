...
def compute_run_metrics(result: BacktestResult, *, prices_moved: bool = False) -> RunMetrics:
    ...
    return RunMetrics(
        ...
        bench_points=sum(getattr(o, "bench_points", 0) for o in outcomes),
        autosub_points=sum(getattr(o, "autosub_points", 0) for o in outcomes),
        captaincy_points=sum(getattr(o, "captain_points", 0) for o in outcomes),
